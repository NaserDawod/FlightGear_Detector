...
void clientSide2(int port,string outputFile)throw (const char*){
    ...
    ofstream out(outputFile);
    ifstream in("/home/naser/CLionProjects/FlightGear_Detector/input.txt");
    string input="";
    while(input!="6"){
        readMenue(out,serverFD);
        getline(in,input);
...
int main(){
    ...
    string outputFile1="/home/naser/CLionProjects/FlightGear_Detector/output_menu.txt";
    string outputFile2="/home/naser/CLionProjects/FlightGear_Detector/output.txt";
//    int x=rand() % 1000;
